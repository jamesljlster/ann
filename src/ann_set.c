...
int ann_config_set_hidden_nodes(ann_config_t config, int hiddenLayerIndex,
                                int nodes)
{
    struct ANN_CONFIG_STRUCT* cfgRef = config;
...
int ann_config_set_transfer_func_of_layer(ann_config_t config, int layerIndex,
                                          int tFuncIndex)
{
    int i;
    struct ANN_CONFIG_STRUCT* cfgRef = config;
...
int ann_set_weight(ann_t ann, int layerIndex, int preNodeIndex, int nodeIndex,
                   float value)
{
    struct ANN_STRUCT* annRef = ann;
    return ann_set_weight_struct(annRef, layerIndex, preNodeIndex, nodeIndex,
                                 value);
}
...
int rnn_set_recurrent_weight(ann_t ann, int preNodeIndex, int nodeIndex,
                             float value)
{
    struct ANN_STRUCT* annRef = ann;
    return ann_set_recurrent_weight_struct(annRef, preNodeIndex, nodeIndex,
                                           value);
}
...
int ann_set_recurrent_weight_struct(struct ANN_STRUCT* sptr, int preNodeIndex,
