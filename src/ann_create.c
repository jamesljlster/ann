...
int ann_create_args(ann_t* annPtr, int inputs, int outputs, int tFuncIndex,
                    float learningRate, float momentumCoef, int hiddenLayers,
                    ...)
{
    int i;
    int iResult;
...
RET:
    if (cfg != NULL) ann_config_delete(cfg);

    return retValue;
}

int ann_config_create_args(ann_config_t* configPtr, int inputs, int outputs,
                           int tFuncIndex, float learningRate,
                           float momentumCoef, int hiddenLayers, ...)
{
    int i;
    int iResult;
    int retValue = ANN_NO_ERROR;
